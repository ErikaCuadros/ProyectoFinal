    ...
    return MaterialApp(
      ...
      home: new Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text("Queen Red",style: TextStyle(color: Color.fromARGB(255, 244, 245, 247),fontFamily: "Varela",fontSize: 20),),
          actions: <Widget>[
            IconButton(
          ...
          children: <Widget>[
            Container(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  SizedBox(height: 20,),
                  Text("Categorias",style: TextStyle(fontFamily: "Verela",fontSize: 42),),
                  SizedBox(height: 20,),
                  TabBar(
                    ...
                    tabs: <Widget>[
                      Tab(
                        child: Text("Recientes",style: TextStyle(fontFamily: "Varela",fontSize: 21),),
                      ),
                      Tab(
                        child: Text("Estrenos",style: TextStyle(fontFamily: "Varela",fontSize: 21),),
                      )
                    ],
                  )
                ],
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: (){},
          backgroundColor: Color.fromARGB(255, 255, 0, 0),//olor(0xFFf17422),
